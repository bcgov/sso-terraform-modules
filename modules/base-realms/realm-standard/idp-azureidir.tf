module "azureidir_idp" {
  ...
  tooltip               = "<span>To learn more about using the Azure IDIR option visit our </span><a href='https://github.com/bcgov/sso-keycloak/wiki/Our-Partners-and-Useful-Information#azure-idir-and-idir' target='_blank' title='additional information' rel='noreferrer'>additional information.</a>"
